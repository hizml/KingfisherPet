...
public enum Language {
    ...
    private static let zh: [String: String] = [
        ...
        "lan.manage": "局域网邻居",
        "settings.lan.duet": "参与对唱(听见邻居唱就应和;关=只唱给自己听)",
    ...
    private static let en: [String: String] = [
        ...
        "settings.lan.duet": "Join duets (answer neighbors; off = sing solo)",
        ...
        "update.autoBody": "New version detected; updating automatically…\nIt will install and restart on its own — nothing to do.\n(Close this window to cancel this update.)",
